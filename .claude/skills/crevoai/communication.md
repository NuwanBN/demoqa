...
ref: communication
pulled_into: [skill]
note: Cross-cutting communication style guide for CrevoAI test-automation work. Applies whenever the CrevoAI skill is active — not for general coding or unrelated tasks.
---

# Communication style

Apply on every user-facing message when doing CrevoAI test-automation work (any node).
...
- Use `crevoai_ask_user` for **missing facts** or **real approvals** (design panel, story draft,
