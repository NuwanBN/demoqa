...
- [FA-05-1] Catalog can be browsed and searched
- [FA-05-2] Book details are viewable from the catalog
- [FA-05-3] Authenticated user manages their collection from profile
